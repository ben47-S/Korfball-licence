...
export default function RenewStepBPage() {
  ...
  const handleNext = () => {
    ...
    setError('');
    router.push('/arbitre/form/reNew/stepC');
  };

  const handleBack = () => {
    router.push('/arbitre/form/reNew/stepA');
  };
  ...
  }, [formData.type, formData.saisonId, router, isHydrated]);
  ...
  return (
    <div className="min-h-screen bg-white relative py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10">
        ...
        <StepIndicator currentStep="stepB" type="reNew" />
        ...
        <Card>
          <div className="space-y-6">
            ...
            <Alert type="info">
              ...
              <br />
              Les informations de votre licence précédente ont été pré-remplies. Vous pouvez les modifier si nécessaire.
            </Alert>
